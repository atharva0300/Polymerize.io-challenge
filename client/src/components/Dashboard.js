    ...
    <div className='bg-sky-600 w-full h-96 flex flex-row justify-around'>
        ...
        >    
          <div className='inner-dashboard'>
            ...
            <p className='self-center text-4xl mt-2 font-semibold text-white font-sans'>{mean}</p>
          </div>
        </motion.div>
        ...
        >
          <div className='inner-dashboard'>
            ...
            <p className='self-center text-4xl mt-2 font-semibold text-white font-sans'>{median}</p>
          </div>
        </motion.div>
      ...
      >
          <div className='inner-dashboard'>
            ...
            <p className='self-center text-4xl mt-2 font-semibold text-white font-sans'>{stdDeviation}</p>
          </div>
        </motion.div>
      ...
      >
          <div className='inner-dashboard'>
            ...
            <p className='self-center text-4xl mt-2 font-semibold text-white font-sans'>{mode}</p>
          </div>
        </motion.div>
